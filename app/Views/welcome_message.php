...
<link href="<?php echo base_url('bootstrap/dist/css/bootstrap.min.css') ?>" rel="stylesheet">
    ...
    <link href="<?php echo base_url('sidebar/sidebars.css') ?>" rel="stylesheet">
  </head>
  <body>
...
<main class="d-flex flex-nowrap">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
    <a href="/login" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
       <img src="<?php echo base_url("images/rs_logo.png")?>"  width="60" height="60" alt="">
...
<script src="<?php echo base_url('bootstrap/dist/js/bootstrap.bundle.min.js') ?>"></script>
    ...
    <script src="<?php echo base_url('sidebar/sidebars.js') ?>"></script></body>
</html>
